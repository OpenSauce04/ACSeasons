...
void load() {
  ...
  grass[3]=loadImage("grass4.png");
  grass[4]=loadImage("grass1.png");
  grass[5]=loadImage("grass2.png");
  grass[6]=loadImage("grass3.png");
  grass[7]=loadImage("grass4.png");
  grass[8]=loadImage("grass5.png");
  grass[9]=loadImage("grass6.png");
